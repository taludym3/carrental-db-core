...
export default function BranchCarDetails() {
  const { id } = useParams();
      ...
      const { data, error } = await supabase
        ...
        .select(`
          *,
          ...
          car_models(name_en, name_ar, default_image_url, year, car_brands(name_en, name_ar, logo_url)),
      ...
      <PageHeader
        ...
        action={
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => navigate("/branch/cars")}>
              <ArrowLeft className="h-4 w-4" />
              العودة
            </Button>
            <Button onClick={() => navigate(`/branch/cars/${id}/edit`)}>
            ...
            <CardContent>
              {car.additional_images?.length > 0 ? (
                <Carousel className="w-full">
                  <CarouselContent>
                    {car.additional_images.map((image: string, index: number) => (
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{car.car_models?.year}</p>
                </div>
                {car.car_colors && (
                  <div>
                ...
                <div>
                  ...
                  <p className="font-medium">{car.branches?.name_ar || car.branches?.name_en}</p>
                </div>
                <div>
          ...
          {(car.description_en || car.description_ar) && (
            <Card>
              ...
              <CardContent className="space-y-4">
                {car.description_ar && (
                  <div>
                    <p className="text-sm">{car.description_ar}</p>
                  </div>
                )}
              </CardContent>
            </Card>
